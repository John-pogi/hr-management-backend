    ...
    public function definition(): array
    {
       // Create a random work day and shift times
        ...
        return [
            ...
            'total_minutes' =>  $this->faker->numberBetween(1, 100),
            'under_time_minutes' =>  $this->faker->numberBetween(1, 100),
            'regular_minutes' => $this->faker->numberBetween(1, 100),
            'late_minutes' => $this->faker->numberBetween(1, 100),
            'approved_overtime' => $this->faker->numberBetween(1, 100),
            'overtime_minutes' => $this->faker->numberBetween(1, 100),
            'leave_credit' => $this->faker->numberBetween(1, 100),
